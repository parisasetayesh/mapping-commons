---
id: read-map-anatomy
title: "Read the Anatomy of a Map"
summary: "Identify the visual and textual elements that guide a reader through a map."
primary_category: reading-maps-critically
categories: [reading-maps-critically, understanding-maps]
lesson_type: critical-reading
level: beginner
duration_minutes: 25
topics: [legend, title, symbols, labels, scale, sources]
tools: []
datasets: []
audiences: [undergraduate-students, community-organizations]
learning_objectives:
  - "Identify the title, legend, symbols, labels, scale, orientation, source, and frame."
  - "Explain how visual hierarchy directs attention."
  - "Distinguish what a map displays from the documentation needed to interpret it."
prerequisites: [what-counts-as-a-map]
